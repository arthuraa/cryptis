...
Proof.
iIntros "(#? & #ctx & #? & #p_ga & #m_skI & #m_skR) !> %Φ P post".
wp_lam; wp_pures.
iPoseProof (ctx_conn_ctx with "[//]") as "?".
iApply wp_fupd.
...
Proof.
iIntros "#ctx". iLöb as "IH".
iIntros "!> %Ψ (conn & inv & #handlers) post".
...
- iDestruct "Hres" as "(inv & conn & rel)". wp_pures.
  by wp_apply ("IH" with "[$inv $rel $conn]") => //.
