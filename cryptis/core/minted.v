...
Proof.
rewrite -{1}[t]base_expsK minted_TExpN //; last exact: no_inv_exps.
exact: atom_exps.
Qed.
...
rewrite (minted_TExpN nx (atom_factors t2)
           (no_inv_factors t2)).
